...
public class Si1145 {
    ...
    public static Promise<BluetoothGattCharacteristic, BletiaException, Void> initialize(KonashiManager manager) {
        ...
        return manager.<BluetoothGattCharacteristic>i2cWrite(data1.length, data1, (byte) PROX_LIGHT_UV_SENSOR_ADDRESS)
    ...
    public static Promise<byte[], BletiaException, Void> readAmbientLight(KonashiManager manager) {
    ...
    public static Promise<byte[], BletiaException, Void> readProximity(KonashiManager manager) {
